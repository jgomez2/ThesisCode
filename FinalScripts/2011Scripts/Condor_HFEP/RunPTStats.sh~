...
cd /home/jgomez2/V1Analysis/EventPlane/January2014/Condor_HFEP/ #some directory where this will be located
./MakePTStats.sh ${1}
...
/bin/mv /home/jgomez2/V1Analysis/EventPlane/January2014/Condor_HFEP/HFV1PTStats_${1}.C .
...
cp HFEP_PTStats_${1}.root /data/users/jgomez2/V1EPFiles/HFEP/PTStats/
