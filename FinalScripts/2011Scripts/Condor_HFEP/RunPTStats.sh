...
cd /home/jgomez2/V1Analysis/2011Analysis/CMSSW_5_3_16/src/2011Scripts/Condor_HFEP #some directory where this will be located
./MakePTStats.sh ${1}
...
/bin/mv /home/jgomez2/V1Analysis/2011Analysis/CMSSW_5_3_16/src/2011Scripts/Condor_HFEP/HFV1PTStats_${1}.C .


#execute
#cmsRun PyConfig_${firstevent}.py >& ZDC_PG_N_1380GeV_1000events_${firstevent}.txt   
root -l -b -q HFV1PTStats_${1}.C

#Move the important output files to the new directory
cp HFEP_PTStats_${1}.root /data/users/jgomez2/V1EPFiles/2011/HFEP/PTStats/
