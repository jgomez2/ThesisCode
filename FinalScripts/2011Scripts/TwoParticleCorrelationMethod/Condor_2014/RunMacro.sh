...
#Make the CFG File
cd /home/jgomez2/V1Analysis/2011Analysis/CMSSW_5_3_16/src/2011Scripts/TwoParticleCorrelationMethod/Condor_2014
./MakeMacro.sh ${1} 

#setup the cmssw environment
export SCRAM_ARCH=slc5_amd64_gcc462 ##this needs to be changed
...
cd /data/users/jgomez2/MacroRunningSpace
...
/bin/mv /home/jgomez2/V1Analysis/2011Analysis/CMSSW_5_3_16/src/2011Scripts/TwoParticleCorrelationMethod/Condor_2014/TwoParticleCorrelation_${1}.C .


#execute
#cmsRun PyConfig_${firstevent}.py >& ZDC_PG_N_1380GeV_1000events_${firstevent}.txt   
root -l -b -q TwoParticleCorrelation_${1}.C
...
cp TwoParticleCorrelationAnalysis_${1}.root /data/users/jgomez2/TwoParticleCorrelationFiles/2011/
