...
/bin/mv /home/jgomez2/V1Analysis/2011Analysis/CMSSW_5_3_16/src/2011Scripts/Condor_HFEP/TRV1EPPlotting_${1}.C .
...
cp TREP_EPPlotting_${1}.root /data/users/jgomez2/V1EPFiles/2011/TREP/EPPlotting/
