...
cd /home/jgomez2/V1Analysis/2011Analysis/CMSSW_5_3_16/src/2011Scripts/Condor_TREP/
...
/bin/mv /home/jgomez2/V1Analysis/2011Analysis/CMSSW_5_3_16/src/2011Scripts/Condor_TREP/TRV1AngularCorrections_${1}.C .

#execute
#cmsRun PyConfig_${firstevent}.py >& ZDC_PG_N_1380GeV_1000events_${firstevent}.txt   
root -l -b -q TRV1AngularCorrections_${1}.C
...
cp TREP_AngularCorrections_${1}.root /data/users/jgomez2/V1EPFiles/2011/TREP/AngularCorrections/
