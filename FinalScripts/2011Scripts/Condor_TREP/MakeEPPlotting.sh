...
void Initialize(){
  ...
  char complexname[128],complextitle[128];
  ...
  for (Int_t i=0;i<NumberOfEvents;i++)
    {
      ...
      for (Int_t z=0;z<jMax;z++)
	{
	  QEP_wholetracker[z]=TComplex(0.);
	  QEP_postracker[z]=TComplex(0.);
	  QEP_negtracker[z]=TComplex(0.);
	  QEP_midtracker[z]=TComplex(0.);
	  QEP_wholeoddtracker[z]=TComplex(0.);
	  QEP_posoddtracker[z]=TComplex(0.);
	  QEP_negoddtracker[z]=TComplex(0.);
	  QEP_midoddtracker[z]=TComplex(0.);
	}
      ...
      for (Int_t c=0;c<nCent;c++)
        {
          ...
          //V1 even
	  //Whole Tracker
          EPwholetracker=(1./1.)*TMath::ATan2(Q_wholetracker[c].Im(),Q_wholetracker[c].Re());
          if (EPwholetracker>(TMath::Pi())) EPwholetracker=(EPwholetracker-(TMath::TwoPi()));
          if (EPwholetracker<(-1.0*TMath::Pi())) EPwholetracker=(EPwholetracker+(TMath::TwoPi()));
	  PsiEvenRaw[c]->Fill(EPwholetracker);


	  //Pos Tracker
          EPpostracker=(1./1.)*TMath::ATan2(Q_postracker[c].Im(),Q_postracker[c].Re());
          if (EPpostracker>(TMath::Pi())) EPpostracker=(EPpostracker-(TMath::TwoPi()));
          if (EPpostracker<(-1.0*TMath::Pi())) EPpostracker=(EPpostracker+(TMath::TwoPi()));
	  PsiPEvenRaw[c]->Fill(EPpostracker);


	  //Neg Tracker
          EPnegtracker=(1./1.)*TMath::ATan2(Q_negtracker[c].Im(),Q_negtracker[c].Re());
          if (EPnegtracker>(TMath::Pi())) EPnegtracker=(EPnegtracker-(TMath::TwoPi()));
          if (EPnegtracker<(-1.0*TMath::Pi())) EPnegtracker=(EPnegtracker+(TMath::TwoPi()));
	  PsiNEvenRaw[c]->Fill(EPnegtracker);
	  
	  
          //Mid Tracker
          EPmidtracker=(1./1.)*TMath::ATan2(Q_midtracker[c].Im(),Q_midtracker[c].Re());
          if (EPmidtracker>(TMath::Pi())) EPmidtracker=(EPmidtracker-(TMath::TwoPi()));
          if (EPmidtracker<(-1.0*TMath::Pi())) EPmidtracker=(EPmidtracker+(TMath::TwoPi()));
	  PsiMEvenRaw[c]->Fill(EPmidtracker);


          //V1 odd
          //Whole Tracker
	  EPwholeoddtracker=(1./1.)*TMath::ATan2(Q_wholeoddtracker[c].Im(),Q_wholeoddtracker[c].Re());
          if (EPwholeoddtracker>(TMath::Pi())) EPwholeoddtracker=(EPwholeoddtracker-(TMath::TwoPi()));
          if (EPwholeoddtracker<(-1.0*TMath::Pi())) EPwholeoddtracker=(EPwholeoddtracker+(TMath::TwoPi()));
	  PsiOddRaw[c]->Fill(EPwholeoddtracker);

	  //Posodd Tracker
          EPposoddtracker=(1./1.)*TMath::ATan2(Q_posoddtracker[c].Im(),Q_posoddtracker[c].Re());
          if (EPposoddtracker>(TMath::Pi())) EPposoddtracker=(EPposoddtracker-(TMath::TwoPi()));
          if (EPposoddtracker<(-1.0*TMath::Pi())) EPposoddtracker=(EPposoddtracker+(TMath::TwoPi()));
	  PsiPOddRaw[c]->Fill(EPposoddtracker);


	  //Neg Tracker
          EPnegoddtracker=(1./1.)*TMath::ATan2(Q_negoddtracker[c].Im(),Q_negoddtracker[c].Re());
          if (EPnegoddtracker>(TMath::Pi())) EPnegoddtracker=(EPnegoddtracker-(TMath::TwoPi()));
          if (EPnegoddtracker<(-1.0*TMath::Pi())) EPnegoddtracker=(EPnegoddtracker+(TMath::TwoPi()));
	  PsiNOddRaw[c]->Fill(EPnegoddtracker);

	  //Mid Tracker
          EPmidoddtracker=(1./1.)*TMath::ATan2(Q_midoddtracker[c].Im(),Q_midoddtracker[c].Re());
          if (EPmidoddtracker>(TMath::Pi())) EPmidoddtracker=(EPmidoddtracker-(TMath::TwoPi()));
          if (EPmidoddtracker<(-1.0*TMath::Pi())) EPmidoddtracker=(EPmidoddtracker+(TMath::TwoPi()));
	  PsiMOddRaw[c]->Fill(EPmidoddtracker);
	      ...
	      QEP_wholetracker[k-1]=TComplex::Exp(TComplex::I()*k*EPwholetracker);
	      QEP_postracker[k-1]=TComplex::Exp(TComplex::I()*k*EPpostracker);
	      QEP_negtracker[k-1]=TComplex::Exp(TComplex::I()*k*EPnegtracker);
	      QEP_midtracker[k-1]=TComplex::Exp(TComplex::I()*k*EPmidtracker);
	      QEP_wholeoddtracker[k-1]=TComplex::Exp(TComplex::I()*k*EPwholeoddtracker);
	      QEP_posoddtracker[k-1]=TComplex::Exp(TComplex::I()*k*EPposoddtracker);
	      QEP_negoddtracker[k-1]=TComplex::Exp(TComplex::I()*k*EPnegoddtracker);
	      QEP_midoddtracker[k-1]=TComplex::Exp(TComplex::I()*k*EPmidoddtracker);


              //v1 even
              //Whole Tracker
	      AngularCorrectionWholeTracker+=((2./k)*(((-SineWholeTracker[c][k-1])*(QEP_wholetracker[k-1].Re()))+((CosineWholeTracker[c][k-1])*(QEP_wholetracker[k-1].Im()))));	      

              //Pos Tracker
              //AngularCorrectionPosTracker+=((2./k)*(((-SinePosTracker[c][k-1])*(cos(k*EPpostracker)))+((CosinePosTracker[c][k-1])*(sin(k*EPpostracker)))));
	      AngularCorrectionPosTracker+=((2./k)*(((-SinePosTracker[c][k-1])*(QEP_postracker[k-1].Re()))+((CosinePosTracker[c][k-1])*(QEP_postracker[k-1].Im()))));

              //Neg Tracker
              //AngularCorrectionNegTracker+=((2./k)*(((-SineNegTracker[c][k-1])*(cos(k*EPnegtracker)))+((CosineNegTracker[c][k-1])*(sin(k*EPnegtracker)))));
	      AngularCorrectionNegTracker+=((2./k)*(((-SineNegTracker[c][k-1])*(QEP_negtracker[k-1].Re()))+((CosineNegTracker[c][k-1])*(QEP_negtracker[k-1].Im()))));

              //Mid Tracker
              //AngularCorrectionMidTracker+=((2./k)*(((-SineMidTracker[c][k-1])*(cos(k*EPmidtracker)))+((CosineMidTracker[c][k-1])*(sin(k*EPmidtracker)))));
	      AngularCorrectionMidTracker+=((2./k)*(((-SineMidTracker[c][k-1])*(QEP_midtracker[k-1].Re()))+((CosineMidTracker[c][k-1])*(QEP_midtracker[k-1].Im()))));
	      ...
	      AngularCorrectionWholeOddTracker+=((2./k)*(((-SineWholeOddTracker[c][k-1])*(QEP_wholeoddtracker[k-1].Re()))+((CosineWholeOddTracker[c][k-1])*(QEP_wholeoddtracker[k-1].Im()))));
	      ...
	      AngularCorrectionPosOddTracker+=((2./k)*(((-SinePosOddTracker[c][k-1])*(QEP_posoddtracker[k-1].Re()))+((CosinePosOddTracker[c][k-1])*(QEP_posoddtracker[k-1].Im()))));
	      ...
	      AngularCorrectionNegOddTracker+=((2./k)*(((-SineNegOddTracker[c][k-1])*(QEP_negoddtracker[k-1].Re()))+((CosineNegOddTracker[c][k-1])*(QEP_negoddtracker[k-1].Im()))));
	      ...
	      AngularCorrectionMidOddTracker+=((2./k)*(((-SineMidOddTracker[c][k-1])*(QEP_midoddtracker[k-1].Re()))+((CosineMidOddTracker[c][k-1])*(QEP_midoddtracker[k-1].Im()))));
          ...
          for (Int_t ii=0;ii<NumberOfHits;ii++)
            {
              ...
              if(fabs(eta)<0.6 && pT>0.4)
                {
		  Veven=TComplex(0.);
		  Veven=TComplex::Exp(TComplex::I()*(phi-EPfinalwholetracker));
		  Double_t v1even= Veven.Re();
		  Vodd=TComplex(0.);
		  Vodd=TComplex::Exp(TComplex::I()*(phi-EPfinalwholeoddtracker));
