...
cd /home/jgomez2/V1Analysis/EventPlane/January2014/Condor_TREP/ #some directory where this will be located
...
/bin/mv /home/jgomez2/V1Analysis/EventPlane/January2014/Condor_TREP/TRV1AngularCorrections_${1}.C .
...
cp TREP_AngularCorrections_${1}.root /data/users/jgomez2/V1EPFiles/TREP/AngularCorrections/
