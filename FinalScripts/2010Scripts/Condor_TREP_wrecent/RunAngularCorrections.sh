...
/bin/mv /home/jgomez2/V1Analysis/EventPlane/January2014/Condor_TREP_wrecent/TRV1AngularCorrections_${1}.C .
...
cp TREP_AngularCorrections_${1}.root /data/users/jgomez2/V1EPFiles/Recenter/AngularCorrections/
