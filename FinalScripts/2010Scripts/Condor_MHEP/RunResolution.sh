...
/bin/mv /home/jgomez2/V1Analysis/EventPlane/January2014/Condor_MHEP/MHV1Resolution_${1}.C .

#execute
#cmsRun PyConfig_${firstevent}.py >& ZDC_PG_N_1380GeV_1000events_${firstevent}.txt   
root -l -b -q MHV1Resolution_${1}.C
...
cp MHEP_Resolution_${1}.root /data/users/jgomez2/V1EPFiles/MHEP/Resolutions/
