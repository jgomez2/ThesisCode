...
cd /home/jgomez2/V1Analysis/EventPlane/January2014/Condor_MHEP/ #some directory where this will be located
...
cd /data/users/jgomez2/MHEPMacroRunningSpace
...
/bin/mv /home/jgomez2/V1Analysis/EventPlane/January2014/Condor_MHEP/MHV1AngularCorrections_${1}.C .

#execute
#cmsRun PyConfig_${firstevent}.py >& ZDC_PG_N_1380GeV_1000events_${firstevent}.txt   
root -l -b -q MHV1AngularCorrections_${1}.C
...
cp MHEP_AngularCorrections_${1}.root /data/users/jgomez2/V1EPFiles/MHEP/AngularCorrections/
