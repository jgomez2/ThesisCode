...
#Make the CFG File
cd /home/jgomez2/V1Analysis/EventPlane/January2014/TwoParticleCorrelationMethod/Condor_2014/ #some directory where this will be located
./MakeMacro.sh ${1} 
...
/bin/mv /home/jgomez2/V1Analysis/EventPlane/January2014/TwoParticleCorrelationMethod/Condor_2014/TwoParticleCorrelation_${1}.C .
...
cp TwoParticleCorrelationAnalysis_${1}.root /data/users/jgomez2/TwoParticleCorrelationFiles/
