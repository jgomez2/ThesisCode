...
/bin/mv /home/jgomez2/EventPlane/January2014/Condor_TREP/TRV1EPPlotting_${1}.C .
...
cp TREP_EPPlotting_${1}.root /data/users/jgomez2/V1EPFiles/TREP/EPPlotting/
