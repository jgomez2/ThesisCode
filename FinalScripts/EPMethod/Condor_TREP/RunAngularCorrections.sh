...
cd /home/jgomez2/EventPlane/January2014/Condor_TREP/ #some directory where this will be located
...
/bin/mv /home/jgomez2/EventPlane/January2014/Condor_TREP/TRV1AngularCorrections_${1}.C .
