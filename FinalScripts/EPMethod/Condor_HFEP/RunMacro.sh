...
#Make the CFG File
cd /home/jgomez2/EventPlane/January2014/2010DataAnalysis/Condor_2014/ #some directory where this will be located
./MakeMacro.sh $firstevent 
...
/bin/mv /home/jgomez2/EventPlane/January2014/2010DataAnalysis/TwoParticleCorrelation_${1}.C


#execute
#cmsRun PyConfig_${firstevent}.py >& ZDC_PG_N_1380GeV_1000events_${firstevent}.txt   
root TwoParticleCorrelation_${1}.C
