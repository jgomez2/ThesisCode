...
#include "Analyzers/ForwardAnalyzer/interface/UPCVertexAnalyzer.h"
...
void UPCVertexAnalyzer::beginJob(){
	...
	VertTree->Branch("NprimaryVertices",&nVert,"n/I");
	...
	VertTree->Branch("NprimaryTracks",nTracks,"nTracks[n]/i");
}
