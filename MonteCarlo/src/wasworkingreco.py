...
# with command line options: Hydjet_Quenched_MinBias_2760GeV_cfi --conditions auto:starthi_HIon --scenario HeavyIons -n 1 --eventcontent RECODEBUG --relval 2000,5 -s DIGI,L1,DIGI2RAW,RAW2DIGI,RECO --no_exec
...
##Associated Tracks
process.RECODEBUGoutput.outputCommands += ['keep *_tpRecoAssochiGeneralTracks_*_*']
